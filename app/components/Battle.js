...
class PlayerInput extends React.Component {
  ...
  render() {
    return (<form className='column' onSubmit={this.handleInputSubmit}>
      {/* for is a protected word in JS so htmlFor ties the label to the input id */}
      <label className='header' htmlFor='username'>{this.props.label}</label>
      <input id='username' placeholder='Enter your github username' type='text' value={this.state.username} onChange={this.handleInputChange} autoComplete='off'/>
  ...
  render() {
    ...
    return (<div>
      <div className='row'>
        ...
        {!playerOneName && <PlayerInput id='playerOne' label='Player One' onSubmit={this.handleFormSubmit}/>}

        {/* If player one's image is not null, render player view passing in data of playerOne from state. */
          ...
          !playerTwoName && <PlayerInput id='playerTwo' label='Player Two' onSubmit={this.handleFormSubmit}/>
        } {
